...
export class CodeTypeService {
    ...
    /**
     * Convert a returned JSON object to CodeType.
     */
    private convertItemFromServer(json: any): CodeType {
        const entity: CodeType = Object.assign(new CodeType(), json);
    ...
    /**
     * Convert a CodeType to a JSON which can be sent to the server.
     */
