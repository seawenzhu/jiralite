...
currentAccount: any;
    ...
    transition() {
        this.router.navigate(['/code-type'], {queryParams:
            {
                page: this.page,
                size: this.itemsPerPage,
    ...
    trackId(index: number, item: CodeType) {
        return item.id;
    }
    ...
    registerChangeInCodeTypes() {
        this.eventSubscriber = this.eventManager.subscribe('codeTypeListModification', (response) => this.loadAll());
    }
