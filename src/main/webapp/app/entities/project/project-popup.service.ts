        ...
        return new Promise<NgbModalRef>((resolve, reject) => {
            ...
            if (id) {
                this.projectService.find(id).subscribe((project) => {
                    project.createdDate = this.datePipe
                        .transform(project.createdDate, 'yyyy-MM-ddTHH:mm:ss');
                    project.lastModifiedDate = this.datePipe
                        .transform(project.lastModifiedDate, 'yyyy-MM-ddTHH:mm:ss');
