...
import static com.seawen.jiralite.web.rest.TestUtil.createFormattingConversionService;
...
public class CodeTypeResourceIntTest {
    ...
    @Test
    @Transactional
    public void checkParentTypeCodeIsRequired() throws Exception {
        int databaseSizeBeforeTest = codeTypeRepository.findAll().size();
        // set the field null
        codeType.setParentTypeCode(null);
